        ...
        <script src="{{ SITEURL }}/theme/js/libs/modernizr-2.6.2.min.js"></script>
			...
			{% if GOOGLE_ANALYTICS %}
				<script type="text/javascript">
                    ...
                    _gaq.push(['_setDomainName', '{{ GOOGLE_ANALYTICS_SITENAME}}'])
    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <header id="banner" class="body">
              ...
              <h4><font color=grey>{{ SITESUBTITLE }}</font></h4>
              -->
          </header><!-- /#banner -->
          ...
          <div class="seven columns">
            <div class="row">
              <ul class="socbtns">
                ...
                {% if SINA_URL %}
                <li><div class="btn info"><a href="{{ SINA_URL }}" target="_blank">新浪微博</a></div></li>
                {% endif %}
